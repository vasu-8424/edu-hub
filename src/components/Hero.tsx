...
export default function Hero({ onOpenEnroll }: HeroProps) {
  return (
    ...
    >
      {/* Handwriting Flow Motion Graphic - SVG Tracing Background with subtle drawing animation */}
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none select-none z-0 opacity-40">
        <svg 
          ...
          aria-hidden="true"
        >
          {/* Subtle graph grid lines representing professional writing worksheet template */}
          <g opacity="0.12">
          ...
          {/* Calligraphic Handwriting Strokes that auto-trace */}
          <path
            ...
            style={{
              animation: 'drawStroke 9s cubic-bezier(0.4, 0, 0.2, 1) infinite alternate',
            }}
          />
          ...
          <path
            ...
            style={{
              animation: 'drawStroke 6s cubic-bezier(0.4, 0, 0.2, 1) infinite alternate',
              animationDelay: '1.5s',
            }}
          />
      ...
      {/* Styled inline animation for handwriting SVG stroke paths */}
      <style>{`
      ...
      <div className="max-w-5xl mx-auto text-center relative z-10 flex flex-col items-center">
        {/* Futuristic Badge */}
        <div 
          className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/5 border border-white/10 text-brand-cyan text-xs font-semibold tracking-wider uppercase mb-8 backdrop-blur-md animate-fade-in"
          id="hero-badge"
        >
          <span className="flex h-2 w-2 rounded-full bg-brand-cyan animate-pulse" />
          <span>India's Pioneer Educational Brand since 2008</span>
        </div>

        {/* Cinematic Headline Reveal */}
        <h1 
          className="font-serif text-4xl sm:text-5xl md:text-7xl font-extrabold text-white tracking-tight leading-[1.1] mb-6 max-w-4xl"
          id="hero-headline"
        >
          Transforming{' '}
        ...
        <p 
          className="text-base sm:text-lg md:text-xl text-slate-300 font-sans font-light max-w-3xl leading-relaxed mb-10"
          id="hero-subheadline"
        >
          India’s Trusted Destination for Professional Handwriting Teacher Training, Calligraphy Excellence & Student Development Since 2008.
        </p>

        {/* Animated Action Buttons */}
        <div 
          className="flex flex-col sm:flex-row items-center gap-4 mb-20 w-full justify-center max-w-3xl px-4"
          id="hero-ctas"
        >
          {/* Enroll Now */}
          <button
          ...
          <a
            href="https://wa.me/919848555800?text=Hi!%20I%20would%20like%20to%20book%20a%20free%20demo%20session%20at%20Alphabet%20Educational%20Hub."
            target="_blank"
          ...
          {/* Contact Us - WhatsApp */}
          <a
            href="https://wa.me/919848555800?text=Hi!%20I%20would%20like%20to%20know%20more%20about%20Alphabet%20Educational%20Hub."
            target="_blank"
            rel="noopener noreferrer"
        ...
        {/* Floating Stats / Trust Indicators Grid */}
        <div 
        ...
        >
          ...
          <div className="glass-panel p-6 rounded-2xl flex flex-col justify-center items-center text-center transform hover:translate-y-[-4px] transition-all duration-400 group">
            ...
            <p className="text-xs text-slate-400 mt-2">
              Transforming penmanship & mental clarity nationwide.
            </p>
          </div>
